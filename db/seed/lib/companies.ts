const companies = [
  ...
  {
    picture: "https://www.cuti.org.uy/data/f/c/socios/660/160x160/logo-kreithech.png",
  ...
  {
    picture:
      "https://www.cuti.org.uy/data/f/c/socios/237/160x160/logo-png-transparente-160x160.png",
    url: "https://www.vairix.com/",
    name: "VAIRIX Software Development",
    description:
      "Nearshore software development company that provides staff augmentation and custom software development services.",
    meta: {
      allowFullRemote: true,
      hasPhysicalOffices: true,
    },
  },
  {
    ...
    name: "ZIRCONTech",
    description:
      "A trusted partner for the technologies driving the future. We help organizations to build their digital transformation.",
    meta: {
      allowFullRemote: true,
      hasPhysicalOffices: true,
    },
